# Video SDK Web 5-Minute Preflight Runbook
...
- Confirm this is a Video SDK custom session flow for Web (not Meeting SDK).
...
- https://marketplacefront.zoom.us/sdk/custom/web/modules.html

### Raw docs in repo

- `raw-docs/developers.zoom.us/docs/video-sdk/web/`
- `raw-docs/marketplacefront.zoom.us/sdk/video-sdk/web/`
